  ...
  return (
    <div className="space-y-8 animate-fade-in-scale">
      <div className="bg-white p-6 rounded-2xl border border-slate-200/80 shadow-xs">
        <h1 className="text-2xl font-extrabold text-slate-900 tracking-tight">Pengeluaran Operasional (OPEX)</h1>
        <p className="text-xs text-slate-500 mt-1">Input transaksi pengeluaran sewa, sewa ruko, gaji, listrik, & biaya operasional lainnya.</p>
      </div>
      ...
      <div className="bg-white rounded-2xl border border-slate-200/80 p-6 space-y-6 shadow-xs">
        ...
        <form onSubmit={handleSubmit} className="space-y-5">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <div>
              <label className="block text-xs font-semibold text-slate-700 mb-2">Kategori Pengeluaran</label>
              <select
      ...
      <div className="bg-white rounded-2xl border border-slate-200/80 overflow-hidden shadow-xs">
        <div className="px-6 py-4 border-b border-slate-100 bg-slate-50/50">
          <h2 className="text-base font-bold text-slate-900">Riwayat Pengeluaran Operasional</h2>
        </div>
